...
export interface ApiHotelInfoHotelInfo extends Struct.SingleTypeSchema {
  collectionName: 'hotel_infos';
  info: {
    displayName: 'Hotel Info';
    pluralName: 'hotel-infos';
    singularName: 'hotel-info';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    relatedRoom: Schema.Attribute.Relation<'manyToOne', 'api::room.room'>;
    room: Schema.Attribute.Relation<'manyToOne', 'api::booking.booking'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiStafStaf extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::staf.staf'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    order: Schema.Attribute.Integer;
